...
| KAT-R1 | [KAT-R1.cfg](KAT-R1.cfg) | Complete capture: VLAN 10/30/50 gateways and native unaddressed VLAN 999; WAN /29 addressing and OSPF area 0 with passive LANs; SSH v2, IT-only ACL 10 on VTY 0–15; account/enable credentials redacted |
...
| RZE-R1 | [RZE-R1.cfg](RZE-R1.cfg) | Complete capture: VLAN 10/30/50 gateways and native unaddressed VLAN 999; WAN /29 addressing and OSPF area 0 with passive LANs; SSH v2, IT-only ACL 10 on VTY 0–15; account/enable credentials redacted |
