...
|---|---|---|
| HQ-L3 | [HQ-L3.cfg](HQ-L3.cfg) | VLAN gateways, DHCP relay, LACP/STP, routed G0/1 at 10.255.1.2/30, core-edge OSPF, SSH v2 and IT-only VTY ACL; complete capture with account credential redacted |
| HQ-R1 | [HQ-R1.cfg](HQ-R1.cfg) | Routed G0/0 at 10.255.1.1/30, core-edge and shared-WAN OSPF, G0/1 at 10.255.0.1/29, SSH v2, admin privilege 15 and IT-only VTY ACL; account credential redacted; complete capture |
...
| KAT-R1 | [KAT-R1.cfg](KAT-R1.cfg) | Complete Sep 17 capture: DHCP relay, VLAN 10/30/50 gateways and native unaddressed VLAN 999; WAN /29 addressing and OSPF area 0 with passive LANs; SSH v2, IT-only ACL 10 on VTY 0–15; account/enable credentials redacted |
...
| RZE-R1 | [RZE-R1.cfg](RZE-R1.cfg) | Complete capture: DHCP relay, VLAN 10/30/50 gateways and native unaddressed VLAN 999; WAN /29 addressing and OSPF area 0 with passive LANs; SSH v2, IT-only ACL 10 on VTY 0–15; account/enable credentials redacted |
...
- Use the matching model and inspect the complete capture before applying it. HQ management, SSH and core-edge OSPF are represented. DHCP relay is present on HQ-L3 Vlan30/50 and branch G0/0.30/.50. PAT and the full routed traffic policy remain unconfigured.
